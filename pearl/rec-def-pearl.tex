...
At the first glance, |RSet| looks like an isomorphic copy of |Set|, with |get :: RSet a -> Set a| and |mk :: Set a -> RSet a| converting between the types, and all the operations on |RSet| behave as their counterpart on |Set|. Let's quickly check that \citep{quickcheck}:
\begin{code}
