...
\acmPrice{}
\acmDOI{10.1145/3607853}
\acmYear{2023}
\copyrightyear{2023}
\acmSubmissionID{icfp23main-p80-p}
\acmJournal{PACMPL}
\acmVolume{7}
\acmNumber{ICFP}
\acmArticle{211}
...
%in |Data.Recursive.Set| is the higher-order function
...
%this plays into the “$A$ has finite height” requirement in the theorem above.
...
\end{itemize}
\Citet{clairvoyant} give a denotational semantics with a cost model of lazy evaluation, and in their semantic domain knot-tying can be recognized. We are currently working on a denotational semantics for our library based on that and welcome interested readers to ask us about it.
